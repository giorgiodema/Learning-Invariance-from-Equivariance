...
class EqSimpleCNNAVGPooling(torch.nn.Module):
    def __init__(self,group,order,nclasses) -> None:
        super().__init__()
        div = int(math.sqrt(order))
        self.c1 = LiftingConvolution(group,in_channels=1,out_channels=64//div,kernel_size=3)
        self.r1 = nn.ReLU()
        self.p1 = SpatialAvgPool2d(kernel_size=2,stride=2)

        self.c2 = GroupConvolution(group,in_channels=64//div,out_channels=128//div,kernel_size=3)
        self.r2 = nn.ReLU()
        self.p2 = SpatialAvgPool2d(kernel_size=2,stride=2)

        self.c3 = GroupConvolution(group,in_channels=128//div,out_channels=256//div,kernel_size=3)
        self.r3 = nn.ReLU()

        self.gp = SpatialGlobalAvgPool()
        self.group_pooling = GroupAvgPool()
        self.clf = nn.Linear(256//div,nclasses)
...
class EqSimpleCNNSigmoid(torch.nn.Module):
    def __init__(self,group,order,nclasses) -> None:
        super().__init__()
        div = int(math.sqrt(order))
        self.c1 = LiftingConvolution(group,in_channels=1,out_channels=64//div,kernel_size=3)
...
class EqSimpleCNNAVGPoolingSigmoid(torch.nn.Module):
    def __init__(self,group,order,nclasses) -> None:
        super().__init__()
        div = int(math.sqrt(order))
        self.c1 = LiftingConvolution(group,in_channels=1,out_channels=64//div,kernel_size=3)
...
class EqFullCNN(torch.nn.Module):
    def __init__(self,group,order,nclasses) -> None:
        super().__init__()
        div = int(math.sqrt(order))
        self.c1 = LiftingConvolution(group,in_channels=1,out_channels=64//div,kernel_size=3)
        ...
        self.c4 = GroupConvolution(group,in_channels=256//div,out_channels=nclasses,kernel_size=1)
        self.gp = GlobalMaxPooling()
        self.group_pooling = GroupMaxPool()
